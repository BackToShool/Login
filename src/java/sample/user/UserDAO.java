...
public class UserDAO {
    ...
    private static final String LOGIN = "SELECT userID, password, roleID, fullName FROM tblUsers WHERE userID= ? AND password = ?";
    ...
    public UserDTO checkLogin(String userID, String password) throws SQLException {
        ...
        UserDTO user = null;
        try {
            conn = sample.utils.DBUtils.getConnection();
            if (conn != null) {
                ...
                if (rs.next()) {
                    ...
                    user = new UserDTO(userID, password, roleID, fullName);
